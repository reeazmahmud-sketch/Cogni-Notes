...
export const ChatBubbleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3h9m-9 3h3m-4.5 1.5l.5-1.5c-1.5-1.5-2.5-3.5-2.5-5.5 0-4.418 3.582-8 8-8s8 3.582 8 8-3.582 8-8 8c-1.5 0-2.5-.5-3.5-1.5l-3 1z" />
    </svg>
);
...
export const TouchIdIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0-2.209-1.791-4-4-4s-4 1.791-4 4 1.791 4 4 4 4-1.791 4-4z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V5.5a3.5 3.5 0 017 0V7" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.5a6.5 6.5 0 01-13 0c0-3.59 2.91-6.5 6.5-6.5h0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.5 12c3.59 0 6.5 2.91 6.5 6.5s-2.91 6.5-6.5 6.5-6.5-2.91-6.5-6.5 2.91-6.5 6.5-6.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.5 15.5v3m-1.5-1.5h3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 11c0-3.866 3.134-7 7-7s7 3.134 7 7" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M20 11c0-4.418-3.582-8-8-8s-8 3.582-8 8" />
...
export const AppleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className={className}>
        <path d="M17.05 20.28c-.96.95-2.11 1.63-3.41 1.63-1.29 0-2.04-.63-3.41-.63-1.38 0-2.27.63-3.41.63-1.3 0-2.45-.68-3.41-1.63-2.03-2.01-3.1-5.12-3.1-7.97 0-4.63 3.01-7.07 5.86-7.07 1.39 0 2.45.62 3.41.62.96 0 2.02-.62 3.41-.62 2.3 0 4.19 1.5 5.09 3.63-4.14 1.72-3.47 7.28.62 9.04-.79 1.95-2.31 4.39-4.66 4.39zm-4.74-17.43c0-2.02 1.64-3.66 3.66-3.66.1 0 .21.01.31.02-.15 2.17-1.92 3.84-4.04 3.64-.15-.71-.24-1.44-.24-2.17z" />
    </svg>
);
...
export const EyeIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12.011a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
  </svg>
);
